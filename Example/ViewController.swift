...
class ViewController: UIViewController {
	...
	let chooseArticleDropDown = MLDropDown()
	let amountDropDown = MLDropDown()
	let chooseDropDown = MLDropDown()
	let centeredDropDown = MLDropDown()
	let rightBarDropDown = MLDropDown()
	
	lazy var dropDowns: [MLDropDown] = {
		return [
	...
	@IBAction func showCenteredMLDropDown(_ sender: AnyObject) {
		centeredDropDown.show()
	}
	
	@IBAction func showBarButtonMLDropDown(_ sender: AnyObject) {
	...
	@IBAction func changeUI(_ sender: UISegmentedControl) {
		switch sender.selectedSegmentIndex {
		case 0: setupDefaultMLDropDown()
		case 1: customizeMLDropDown(self)
		default: break;
		}
	}
	...
	func setupDefaultMLDropDown() {
        MLDropDown.setupDefaultAppearance()
		
		dropDowns.forEach {
			$0.cellNib = UINib(nibName: "MLDropDownCell", bundle: Bundle(for: MLDropDownCell.self))
			$0.customCellConfiguration = nil
		}
	}
	
	func customizeMLDropDown(_ sender: AnyObject) {
		let appearance = MLDropDown.appearance()
...
//		appearance.textFont = UIFont(name: "Georgia", size: 14)
		...
		dropDowns.forEach {
			...
			$0.customCellConfiguration = { (index: Index, item: String, cell: MLDropDownCell) -> Void in
	...
	func setupDropDowns() {
		setupChooseArticleMLDropDown()
		setupAmountMLDropDown()
		setupChooseMLDropDown()
		setupCenteredMLDropDown()
		setupRightBarMLDropDown()
	}
	
	func setupChooseArticleMLDropDown() {
